...
const sidebarCSS = `<link rel="stylesheet" href="/pages/sidebar/sidebar.css">`;
...
//Scripts
const sidebarJS = `<script src="/sidebar/sidebar.js"></script>`;
const loginJS = `<script src="/login/login.js"></script>`;
...
const highlightALL = `<script>hljs.highlightAll();</script>`;
