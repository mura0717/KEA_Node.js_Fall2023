//Sidebar Home Icon:
const homeIcon =`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
...
document.addEventListener("DOMContentLoaded", function homeIconOnPageLoad() {
  document.getElementById(".home-icon").innerHTML = homeIcon;
})
...
//OnClick Arrow Interchange Function:
