<script>
  ...
  async function handleSignUp() {
    if(!name || !email || !password || (checkbox= false)){
      return //send toastr error.
    }
                  ...
                  <div class="relative mb-4" data-te-input-wrapper-init>
                   ...
                   <div class="mb-2 block min-h-[1.5rem] pl-[1.5rem]">
                    ...
                    <label
                      ...
                      for="checkboxDefault"
                    >
                      I agree all statements in <a href="https://i.imgur.com/EZVDzF2.jpeg" target="_blank">Terms of service</a>
                    </label>
                  </div>
                     <!--Submit button-->
